<?
/* Template Name: Lekcje tenisa doroslych Page */
?>
    ...
    <section class="lecture-page">
      <div class="lecture-page__bunner">
        ...
        <div class="lecture-page__bunner-container">
          ...
          ?>
            <a class="button button_lecture-page button_lecture-orange wow fadeInRight" data-wow-delay="0.2s" href="<?php echo esc_url( $link_url ); ?>"><?php echo esc_html( $link_title ); ?></a>
          <?php endif; ?>
        </div>
      </div>
      <div class="lecture-page__container track">
        ...
        <div class="lecture-page__right orange wow fadeInDown" data-wow-delay="0.5s">
          ...
          if( $link ):
            ...
            $link_title = $link['title'];
          ?>
            <a class="button button_lecture-page button_lecture-orange" href="<?php echo esc_url( $link_url ); ?>"><?php echo esc_html( $link_title ); ?></a>
          <?php endif; ?>
        </div>
      </div>
    </section>
