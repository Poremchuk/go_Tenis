<?
/* Template Name: Lekcje tenisa Page */
?>
    ...
    <section class="lecture-page">
      <div class="lecture-page__bunner">
        ...
        <div class="lecture-page__bunner-container">
          ...
          ?>
            <a class="button button_lecture-page wow fadeInRight" data-wow-delay="0.2s" href="<?php echo esc_url( $link_url ); ?>"><?php echo esc_html( $link_title ); ?></a>
          <?php endif; ?>
        </div>
      </div>
      <div class="lecture-page__container track">
        ...
        <div class="lecture-page__right wow fadeInDown" data-wow-delay="0.5s">
          ...
          if( $link ):
            ...
            $link_title = $link['title'];
          ?>
            <a class="button button_lecture-page" href="<?php echo esc_url( $link_url ); ?>"><?php echo esc_html( $link_title ); ?></a>
          <?php endif; ?>
        </div>
      </div>
    </section>
